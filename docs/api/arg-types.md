...
<!-- TODO <CodeSnippets
  paths={[
    'angular/arg-types-default-value.DEPRECATED.ts.mdx',
    'angular/arg-types-default-value.ts.mdx',
    'web-components/arg-types-default-value.DEPRECATED.js.mdx',
    'web-components/arg-types-default-value.js.mdx',
    'web-components/arg-types-default-value.DEPRECATED.ts.mdx',
    'web-components/arg-types-default-value.ts.mdx',
    'common/arg-types-default-value.DEPRECATED.js.mdx',
    'common/arg-types-default-value.js.mdx',
    'common/arg-types-default-value.DEPRECATED.ts.mdx',
